...
| Worker launch animation | `docs/assets/worker_launch_demo.gif` | Short public-safe GIF demo of workers producing rollouts and the trainer updating a checkpoint. |
| Worker launch SVG fallback | `docs/assets/worker_launch_demo.svg` | Vector fallback for the worker/trainer loop animation. |
